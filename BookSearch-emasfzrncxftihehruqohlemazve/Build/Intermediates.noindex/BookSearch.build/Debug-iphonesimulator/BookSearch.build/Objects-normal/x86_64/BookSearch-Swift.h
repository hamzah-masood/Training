...
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified detailInfo;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC10BookSearch13TableViewCell")
@interface TableViewCell : UITableViewCell
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified theInfo;
...
@property (nonatomic, strong) IBOutlet UITextField * _Null_unspecified SearchItem;
