...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="pokedexProject",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14pokedexProject11AppDelegate")
...
SWIFT_CLASS("_TtC14pokedexProject18NextViewController")
@interface NextViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified pokeImage;
...
SWIFT_CLASS("_TtC14pokedexProject13SceneDelegate")
...
SWIFT_CLASS("_TtC14pokedexProject14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(pokedexProject)) <UITableViewDelegate>
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
@end

@class UITableViewCell;

@interface ViewController (SWIFT_EXTENSION(pokedexProject)) <UITableViewDataSource>
